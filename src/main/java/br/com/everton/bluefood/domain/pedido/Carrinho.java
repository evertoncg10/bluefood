...
public class Carrinho {
    ...
    public void adicionarItem(ItemCardapio itemCardapio, Integer quantidade, String observacoes) throws RestauranteDiferenteException {
        ...
        if (!exists(itemCardapio)) {
            ItemPedido itemPedido = criarItemPedido(itemCardapio, quantidade, observacoes);
    ...
    private ItemPedido criarItemPedido(ItemCardapio itemCardapio, Integer quantidade, String observacoes) {
